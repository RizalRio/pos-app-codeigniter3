...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<script>
		var readUrl = '<?php echo site_url('stok_keluar_bahan/read') ?>';
		var addUrl = '<?php echo site_url('stok_keluar_bahan/add') ?>';
		var getBahanUrl = '<?php echo site_url('bahan_baku/get_bahan_select') ?>';
	</script>
	<script src="assets/js/unminify/stok_keluar_bahan.js"></script>
</body>
