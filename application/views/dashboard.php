          ...
          <div class="col-lg-4 col-sm-6">
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <p>Nominal Transaksi Hari Ini</p>
              </div>
              <div class="icon">
...
<script>
  ...
  var transaksi_terakhirUrl = '<?php echo site_url('transaksi/transaksi_terakhir') ?>';
	var transaksi_nominalUrl = '<?php echo site_url('transaksi/transaksi_nominal') ?>';
  ...
  var penjualan_bulanUrl = '<?php echo site_url('transaksi/penjualan_bulan') ?>';
	var grafik_bulanUrl = '<?php echo site_url('transaksi/grafikPenjualan') ?>';
</script>
