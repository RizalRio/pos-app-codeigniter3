...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('assets/vendor/adminlte/plugins/summernote/summernote-bs4.css') ?>">
...
<body class="hold-transition sidebar-mini layout-fixed">
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col">
							<h1 class="m-0 text-dark">Sumber</h1>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container-fluid -->
			</div>
			...
			<section class="content">
				<div class="container-fluid">
					<div class="card">
						...
						<div class="card-body">
							<table class="table w-100 table-bordered table-hover" id="data-sumber">
								<thead>
									<tr>
										<th>No</th>
										<th>Nama</th>
	...
	<script>
		var readUrl = '<?php echo site_url('sumber/read') ?>';
		var addUrl = '<?php echo site_url('sumber/add') ?>';
		var deleteUrl = '<?php echo site_url('sumber/delete') ?>';
		var getSumberUrl = '<?php echo site_url('sumber/get_sumber') ?>';
		var editUrl = '<?php echo site_url('sumber/edit') ?>';
	</script>
	<script src="<?php echo base_url('assets/js/unminify/sumber.js') ?>"></script>
</body>
