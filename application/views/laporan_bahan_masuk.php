...
<body class="hold-transition sidebar-mini layout-fixed">
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col">
							<h1 class="m-0 text-dark">Laporan Bahan Masuk</h1>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container-fluid -->
			</div>
					...
					<div class="card">
						...
						<?php if ($role === 'admin'|| $role === 'superadmin') : ?>
							<div class="card-header">
								<form action="<?php echo site_url('laporan_bahan_masuk/exportToExcel') ?>" method="post">
						...
						<?php endif; ?>
						<div class="card-body">
							<table class="table w-100 table-bordered table-hover" id="laporan_bahan_masuk">
								<thead>
									<tr>
										<th>No</th>
										<th>Tanggal</th>
	...
	<script>
		var laporanUrl = '<?php echo site_url('stok_masuk_bahan/read') ?>';
	</script>
	<!-- <script src="<?php echo base_url('assets/js/laporan_stok_masuk.min.js') ?>"></script> -->
	<script src="<?php echo base_url('assets/js/unminify/laporan_bahan_masuk.js') ?>"></script>
</body>
