...
<body class="hold-transition sidebar-mini layout-fixed">
				...
				<div class="modal-body">
					<form id="form">
						...
						<div class="form-group">
							...
							<select name="nama" id="nama" class="form-control select2" required></select>
						</div>
						<div class="form-group">
							<label>Jumlah</label>
	...
	<script>
		var readUrl = '<?php echo site_url('stok_masuk_bahan/read') ?>';
		var addUrl = '<?php echo site_url('stok_masuk_bahan/add') ?>';
		var getBahanUrl = '<?php echo site_url('bahan_baku/get_bahan_select') ?>';
		var supplierSearchUrl = '<?php echo site_url('supplier/search') ?>';
	</script>
	<script src="<?php echo base_url('assets/js/unminify/stok_masuk_bahan.js') ?>"></script>
</body>
