...
<body class="hold-transition sidebar-mini layout-fixed">
			...
			<section class="content">
				<div class="container-fluid">
					<div class="card">
						...
						<div class="card-body">
							<table class="table w-100 table-bordered table-hover" id="bahan_baku">
								<thead>
									<tr>
										<th>No</th>
										<th>Gambar</th>
				...
				<div class="modal-body">
					<form id="form" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<img id="gambarReview" src="<?= base_url('uploads/default.jpg') ?>" style="width:50vh; height: 45vh;" class="mr-4 mt-4">
						</div>
	...
	<script>
		...
		var readUrl = '<?php echo site_url('bahan_baku/read') ?>';
		var addUrl = '<?php echo site_url('bahan_baku/add') ?>';
		var deleteUrl = '<?php echo site_url('bahan_baku/delete') ?>';
		var editUrl = '<?php echo site_url('bahan_baku/edit') ?>';
		var getBahanUrl = '<?php echo site_url('bahan_baku/get_bahan') ?>';
		var satuanSearchUrl = '<?php echo site_url('satuan_produk/search') ?>';
	</script>
	<!-- <script src="<?php echo base_url('assets/js/produk.min.js') ?>"></script> -->
	<script src="<?php echo base_url('assets/js/unminify/bahan_baku.js') ?>"></script>
</body>
