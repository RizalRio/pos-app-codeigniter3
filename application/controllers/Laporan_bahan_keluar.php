...
class Laporan_bahan_keluar extends CI_Controller
{

	public function __construct()
	{
		parent::__construct();
		$this->load->model('stok_keluar_bahan_model', 'stok_bahan');
	}
	...
	public function index()
	{
		...
		$this->load->view('laporan_bahan_keluar');
	}
	...
	public function exportToExcel()
	{
		...
		$data = $this->stok_bahan->getBahanKeluarByDate($start, $end);
		...
		header('Content-Disposition: attachment;filename="Laporan Stok Keluar Bahan ' . date('d-m-Y') . '.xlsx"');
